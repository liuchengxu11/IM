...
sendSmsMessage=Sheet().kf_sheet(row_id=6, column_id=3)
...
class Test_case():
    ...
    # @pytest.mark.parametrize("msgType,businessSystem,dingWebHookUrl,atMobiles,isAtAll,title,content,messageUrl,picUrl,sendType,deptId,userId,sendUserId,case", dingding_sendMessage)
    # def test_dingding_news_sendMessage(self,msgType,businessSystem,dingWebHookUrl,atMobiles,isAtAll,title,content,messageUrl,picUrl,sendType,deptId,userId,sendUserId,case):
    #     """
    #     钉钉机器人群消息推送
    #     :return:
    #     """
    ...
    #         "picUrl":picUrl, # 图片url
    #         "sendType":sendType,  # 发送消息类型 WorkNotice 工作通知，GroupNews 群消息
    #         "deptId":deptId, # 工作通知 接收的部门ID
    #         "userId":userId, # 工作通知 接收的用户ID
    #         "sendUserId":sendUserId  # 工作通知 发送用户的ID
    #     }
    #     allure.attach(
    #         json.dumps(
    #             data,
    ...
    # @allure.epic("短信")
    # @allure.feature("发送短信消息接口")
    # @pytest.mark.parametrize(
    #     "phoneNumbers,signName,templateCode,templateParam,case",
    #     sendSmsMessage)
    # def test_dingding_news_sendMessage(self,phoneNumbers,signName,templateCode,templateParam,case):
    #     """
    #     发送短信消息接口
    #     :return:
    #     """
    #     uri = "/api/v0.1/im/smsMessage/sendSmsMessage"
    #     allure.attach(
    #         SX_PC_kf_IM_API +
    #         uri,
    #         "地址",
    ...
    #         "templateParam": {"code":templateParam},  # 短信模板参数，key-vlue
    #         #  {"phoneNumbers":"131","signName":"店易火","templateCode":"SMS_185246698","templateParam":{"code":"2222"}}
    #     }
    #     allure.attach(
    #         json.dumps(
    #             data,
    ...
    #     if code == 200 and str(code1 == 200):
    #         print(
    #             "---------/api/v0.1/im/smsMessage/sendSmsMessage接口调用成功")
    #     else:
    #         print(
    #             "---------/api/v0.1/im/smsMessage/sendSmsMessage接口调用失败")
